...
public class VagaIT {
    ...
    @Test
    public void criarVaga_SemPermissaoAcesso_RetornarErrorStatus403() {
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@gmail.com", "123456"))
                .bodyValue(new VagaCreateDto("A-13", "LIVRE"))
                .exchange()
    ...
    @Test
    public void criarVaga_ComCodigoJaExistente_RetornarErrorStatus409() {
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void createVaga_ComDadoInvalidos_RetornarErroMessageStatus422(){
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@gmail.com", "123456"))
                .bodyValue(new VagaCreateDto("A-555", "DESCOCUPADA"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody()
    ...
    @Test
    public void buscarVaga_ComCodigoInexistente_RetornarErrorStatus404() {
        testClient
                .get()
    ...
    @Test
    public void buscarVaga_ComCodigoSemPermissao_RetornarErrorStatus403() {
        testClient
                .get()
                .uri("/api/v1/vagas/{codigo}", "A-10")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@gmail.com", "123456"))
