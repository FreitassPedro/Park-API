...
public class EstacionamentoIT {
    ...
    public void criarCheckIn_ComDadosValidos_RetornarCreatedAndLocation() {
        EstacionamentoCreateDto createDto = EstacionamentoCreateDto.builder()
                .placa("WER-1111").marca("FIAT").modelo("PALIO 1.0").cor("AZUL")
    ...
    @Test
    public void buscarCheckIn_ComComPerfilAdmin_RetornarDadosStatus200() {
    ...
    @Test
    public void buscarCheckIn_ComComPerfilCliente_RetornarDadosStatus200() {
