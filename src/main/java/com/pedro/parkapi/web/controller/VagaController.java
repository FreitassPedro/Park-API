...
import com.pedro.parkapi.service.VagaService;
import com.pedro.parkapi.web.dto.VagaCreateDto;
import com.pedro.parkapi.web.dto.VagaResponseDto;
import com.pedro.parkapi.web.dto.mapper.VagaMapper;
...
public class VagaController {
    ...
    @Operation(summary = "Criar uma nova vaga", description = "Recurso para criar uma nova vaga. " +
            ...
            responses = {
                    @ApiResponse(responseCode = "201", description = "Recurso criado com sucesso",
                            headers = @Header(name = HttpHeaders.LOCATION, description = "URL do recurso criado com sucesso")),
    ...
    @Operation(summary = "Localizar uma vaga", description = "Recurso para retornar uma vaga. " +
            "Requisição exige uso de um bearer token. Acesso restrito a Role='ADMIN'",
            security = @SecurityRequirement(name = "security"),
            responses = {
                    @ApiResponse(responseCode = "200", description = "Recirso criado com sucesso",
                            content = @Content(mediaType = " application/json;charset=UTF-8",
